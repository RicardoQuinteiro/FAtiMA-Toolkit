...
namespace MCTS.DST.Actions
{
    class NextAction
    {
        ...
        public Pair<string, string> ConstructNextAction()
        {
            ...
            Pair<string, string> pair = new Pair<string, string>("Action(PICKUP, -, -, -, -)", itemToGrab);
            return pair;
        ...
        //public Boolean IsInInventory(string guid)
        //{
        //    string strEntInventory = "InInventory(" + guid + ")";
        //    var entInventory = KnowledgeBase.AskProperty((Name)strEntInventory);
        //    var inventoryQ = entInventory.Value.ToString();

        //    return inventoryQ == "True";
        //}

        //public Boolean IsInEquipped(string guid)
        //{
        //    string strEntEquipped = "IsEquipped(" + guid + ")";
        //    var entEquipped = KnowledgeBase.AskProperty((Name)strEntEquipped);
        //    var equippedQ = entEquipped.Value.ToString();
        //    return equippedQ == "True";
        //}
    }
}
